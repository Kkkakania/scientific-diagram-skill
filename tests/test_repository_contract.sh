...
require_text "README.md" "CODE_OF_CONDUCT.md"
...
require_text "README.zh-CN.md" "CODE_OF_CONDUCT.md"
...
require_text "CODE_OF_CONDUCT.md" "private or identifying material"
require_text "CODE_OF_CONDUCT.md" "SECURITY.md"
...
require_text ".github/workflows/issue-triage.yml" "run_gh()"
require_text ".github/workflows/issue-triage.yml" "max_attempts=3"
require_text ".github/workflows/issue-triage.yml" "HTTP 5"
...
require_text ".github/workflows/quality.yml" "permissions:"
require_text ".github/workflows/quality.yml" "contents: read"
