...
if grep -RInE "(/[Uu]sers/|/[Hh]ome/|/[Mm]nt/[A-Za-z]/|[A-Za-z]:\\\\[Uu]sers\\\\|%USERPROFILE%[\\\\/]|/workspaces/|/Volumes/|[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}|身份证|银行卡|手机号|家庭住址|微信号)" "$ROOT_DIR/README.md" "$ROOT_DIR/README.zh-CN.md" "$ROOT_DIR/docs" "$ROOT_DIR/skills"; then
